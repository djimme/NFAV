...
new_codes = ['005830','082640','000400','085620','032830','000810','031210',
             '003690','088350','000370','001450','000540']

prev_ref_code = '016610'  # DB증권 (앞서 분석한 종목)
...
# 1) 신규 12개 종목 내부 비교
out += compare_group(new_codes, '신규 12개 종목 내부 비교', results)
...
output = '\n'.join(out)
with open('temp_comp/structure_check4.txt', 'w', encoding='utf-8') as f:
    f.write(output)
print('\nsaved to temp_comp/structure_check4.txt')
